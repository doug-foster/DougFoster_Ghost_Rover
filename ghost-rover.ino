 ...
 * @since    0.4.4 [2025-05-15-06:30pm].
...
// -- Version. --
const char BUILD_DATE[]   = "2025-05-13-18:30";	            // 24hr format, need to fit max (16) characters.
...
void checkDebug() {
	...
	if (debugPgm) {
        Serial.printf(
            "PgmSection= %c  RoverMode= %c\n",
            pgmState[0],                // Program section (-,s,l).
            pgmState[1]                 // Rover mode (-,b,p).
        );
    }
	...
	if (debugNet) {
        Serial.printf(
            "BLE= %c  WiFi= %c\n",
            netState[0],        // BLE data (d,u).
            netState[1]         // WiFi data (d,u).
        );
    }
}
